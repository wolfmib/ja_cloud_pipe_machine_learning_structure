...
# Batch processing: Collect all images into a list
images = []
file_names = []
...
# Convert list to a numpy array and preprocess
images = np.array(images)
images /= 255.0  # Normalize the entire batch
...
for i, prediction in enumerate(predictions):
    ...
    print(f"The prediction {prediction} for {file_names[i]} is {class_label}.")
